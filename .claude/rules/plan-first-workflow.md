...
1. **Switch to planning behavior** — do not edit files yet
...
6. **Mark plan approved** — only after explicit user approval
...
- Context reset only when state is genuinely polluted
