...
- User uploads PDF to `master_supporting_docs/supporting_papers/` or another project-specific subfolder
...
- Only read those sections in detail for the current research task
