...
- Verify estimator implementations match formulas documented in papers/notes
...
```r
ggsave(filepath, width = 10, height = 6)
```

## 5. RDS Data Pattern

**Heavy computations saved as RDS; Quarto/report rendering loads pre-computed data.**
...
|---------|--------|------------|
| Inconsistent output dimensions | Unreadable manuscript figures | Standardize `ggsave()` width/height |
...
[ ] Figures: explicit dimensions and readable typography
